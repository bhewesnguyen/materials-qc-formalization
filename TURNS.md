...
| 6 | markov | v1 | `markov-milestone-v1` at commit `4795b8b6dc6ec7a831b9158affe3ee199f60e01e` (receipt `deliverables/markov/v1/RECEIPT.json`) | `deliverables/markov/v1/HANDOFF.md` | `audits/markov/v1/Formal_Science_Markov_Audit_v1.md` | 2026-09-21 | Accepted. No proof revision; M1 and M2 (low, documentation) recorded in D020. Seventh accepted mathematical increment. Next checkpoint: Stage 5 release readiness. |
| 7 | release-readiness | v1 | `release-readiness-milestone-v1` at commit `2a258df6654d1b3553d3affebd7e94405bb4e989` (receipt `deliverables/release-readiness/v1/RECEIPT.json`) | `deliverables/release-readiness/v1/HANDOFF.md` | `audits/release-readiness/v1/Formal_Science_Release_Readiness_Audit_v1.md` | 2026-09-21 | Accepted. Documentation, provenance, consumer-reproduction, and packaging candidate; no new mathematical API. R1 to R3 (low, documentation) closed in the integration commit (D022). Not an eighth mathematical increment. Closure: no implementation task active; next contract or publication decision is the owner's. |
