...
| 5 | convergence | v1 | `convergence-milestone-v1` at commit `a3cbac0692b4c106a89e80c91d18b0c2de4988cd` (receipt `deliverables/convergence/v1/RECEIPT.json`) | `deliverables/convergence/v1/HANDOFF.md` | `audits/convergence/v1/` (pending) | 2026-09-21 | Pending independent audit. |
