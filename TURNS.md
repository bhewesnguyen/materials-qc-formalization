...
| 4 | kraus | v1 | `kraus-milestone-v1` at commit `6431c9cd411a3a804d2a86ae733e23f393fe9361` (receipt `deliverables/kraus/v1/RECEIPT.json`) | `deliverables/kraus/v1/HANDOFF.md` | `audits/kraus/v1/` (pending) | 2026-09-21 | Pending independent audit. |
