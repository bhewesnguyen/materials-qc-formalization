...
| 6 | markov | v1 | `markov-milestone-v1` at commit `4795b8b6dc6ec7a831b9158affe3ee199f60e01e` (receipt `deliverables/markov/v1/RECEIPT.json`) | `deliverables/markov/v1/HANDOFF.md` | `audits/markov/v1/` (pending) | 2026-09-21 | Pending independent audit. |
